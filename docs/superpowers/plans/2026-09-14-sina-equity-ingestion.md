...
> 历史计划（已废止）：MySQL 版本和验收指令已由 [REQ-2026-002](../../changes/archive/legacy/REQ-2026-002-mysql8-cross-architecture.md)与[MySQL 设计](../../design/internal/infrastructure/mysql.md)取代，不得直接执行本文的旧步骤。
