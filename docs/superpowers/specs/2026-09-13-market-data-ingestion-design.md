...
> 历史规格（已废止）：MySQL 验收方式已由 [REQ-2026-002](../../changes/archive/legacy/REQ-2026-002-mysql8-cross-architecture.md)与[MySQL 设计](../../design/internal/infrastructure/mysql.md)取代；当前行为以模块 `DESIGN.md` 为准。
