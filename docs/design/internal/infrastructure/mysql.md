...
证券只按 SSE `600/601/603/605/688/689`、SZSE `000/001/002/003/300/301`、BSE `4/8/920` 前缀解析六位代码。报告包含合法源证券数、日周 Bar 数和日期范围、最后已提交源主键（dry-run 为已读取主键）、源 SHA-256 和各证券转换批次摘要累积的发布摘要。未知代码进入拒绝清单。
